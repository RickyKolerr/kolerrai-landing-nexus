          ...
          <div className="relative mx-auto max-w-7xl px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground sm:text-xl mb-8 slide-up">
                Real-time insights and analytics to drive your business decisions
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-accent/10">
                ...
                <p className="text-muted-foreground mb-6">
                  Comprehensive analytics tools powered by AI to track and optimize your business metrics.
                </p>
